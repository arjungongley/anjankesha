...
const ChildNavbar = ({ toggle}) => {
  ...
  return (
    ...
    <Nav  scrollNav={scrollNav} >
      <NavContainer>
        <NavLink href="/">
         <NavLinkA aria-label="Anjankesaha Enterprises Home">{LogoValue === "text" ? <Link href="https://anjankesahaenterprises.netlify.app/"><LogoText>Anjankesaha Enterprises.</LogoText></Link> :<Logo src={LogoImage.src} alt="logo" />}</NavLinkA>
        </NavLink>
